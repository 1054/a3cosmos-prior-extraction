...
# Set Output dir
# 
OutputDir="Read_Results_of_Prior_Extraction_with_Master_Catalog_v20170609" #<TODO>#
...
for (( i=0; i<${#SciImages[@]}; i++ )); do
    ...
    for fit_step in getpix fit_0 fit_1 getpix_on_negative_image fit_n0 fit_n1; do
