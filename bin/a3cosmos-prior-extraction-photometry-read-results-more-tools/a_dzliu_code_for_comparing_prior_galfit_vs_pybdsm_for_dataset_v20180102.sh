...
cat_prior="../A-COSMOS_prior_2018-06-01a_Gaussian_with_meta.fits"
cat_pybdsm="../../../Blind_Extraction_by_Benjamin/20180329/cat_pybdsm_concatenated_290318_Jy_within_cosmos_without_very_high_res_projects.fits"
...
topcat -stilts plot2plane \
                ...
                shading1=aux \
                leglabel1='\small Prior \ galfit \ vs \ PyBDSM' \
                x1="Maj_deconv_pybdsm*3600.0/beam_maj_pybdsm" \
                y1="Maj_deconv_prior*3600.0/beam_maj_prior" \
                \
                layer9=function \
                fexpr9='(x)' \
                color9=black \
